...
unordered_map<string,string> mapper_to_name;
    ...
    if(mp2[node].annotation.substr(0,6) == "symbol"){
        ...
        // File << str << endl;
            ...
            if(str == "filter"){
                ...
                //  cout << node << " " << fieldMapper[node].first << " " << str << endl;
...
int main(int argc,char **argv){
    ...
    string inp_file = n + "/input" + n + ".txt";
    string op_file = n + "/temp" + n + ".js";
    cout << inp_file << " " << op_file << endl;
    ...
    for(int i=(int)mp.size()-1;i>=0;i--){
        ...
        if(y.annotation.substr(0,6) == "symbol"){
            ...
            //
                ...
                if(r == "RECORD_2")  r = "ds";
                /*
                not able to link ds to this still :(
                problem with RECORD_2 is it cannot be used while filtering even though we know the
                structure of RECORD_2
                */
            ...
            // -----------
                ...
                fieldMapper[le] = {fieldMapper[y.right[0]].first + op + fieldMapper[y.right[1]].first,"conditional"};
            }
            else if(func == "filter"){
    ...
    for(auto x : nodes){
        // File << x << " : [";
        // cout << x.substr(1,x.size()-2) << "\n";
        string node_name = x;
        // if(mapper_to_name.find(x.substr(1,x.size()-2)) != mapper_to_name.end())  
        //     cout << x << " ",x = "`" + mapper_to_name[x.substr(1,x.size()-2)] + "`",cout << x << "\n",cout << node_fields[x].size() << endl;
